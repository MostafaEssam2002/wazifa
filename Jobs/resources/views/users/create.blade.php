            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input type="radio" id="candidate" name="status" value="candidate" class="form-check-input" checked>
                                    <label for="candidate" class="form-check-label">Candidate</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="employer" name="status" value="employer" class="form-check-input">
                        ...
                        <!-- إضافة حقل رفع السيرة الذاتية -->
                        <div class="row mb-3">
                            <label for="cv" class="col-md-4 col-form-label text-md-end">{{ __('Upload CV') }}</label>

                            <div class="col-md-6">
                                <input id="cv" type="file" class="form-control @error('cv') is-invalid @enderror" name="cv" accept=".pdf">
